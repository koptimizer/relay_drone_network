"""v3 계층 정책과 탐욕 베이스라인을 여러 에피소드 연속으로 이어붙여 GIF로 저장한다.
...
from pipeline.eval_v3_26_08_31_19 import (action_mask, rule_manager, straight_worker)
...
def make_policies(args, env, dev):
	...
	return left, (wf, mf, "Proposed (hierarchical MARL)")


def main():
	"""여러 에피소드를 이어붙여 좌우 비교 GIF를 저장한다."""
	p = argparse.ArgumentParser()
	p.add_argument("--worker", default="weights/v3_26_09_01_m2_s1/best_worker.pth")
	p.add_argument("--manager", default="weights/v3_26_09_01_m2_s1/best_manager.pth")
	...
	p.add_argument("--out", default="v3_10ep_26_09_02_15.gif")
	args = p.parse_args()
