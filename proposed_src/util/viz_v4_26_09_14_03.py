...
from env.disaster_relay_env_v4_26_09_14_03 import DisasterRelayDroneEnv, GOAL_RELAY
...
C = {"bg": (250, 250, 252), "cc": (30, 80, 200), "dest": (220, 60, 60),
     ...
     "relay": (150, 60, 200), "hud": (28, 30, 36), "fg": (232, 234, 238), "muted": (150, 155, 165)}
...
def panel(surf, env, fonts, title, ep, n_ep, step, cum):
	...
	for i in range(env.num_drones):
		if env.goal_kind[i] == GOAL_RELAY:      # 중계 슬롯을 십자로 표시
